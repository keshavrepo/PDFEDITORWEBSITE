 ...
 * local store.
 *
 * Mirrors the DevPilot /api/devpilot/history/route.ts shape.
 */
...
export async function PUT(request: NextRequest) {
  ...
  const limit = checkRateLimit(`web-history:${user.id}`, 60, 60_000);
