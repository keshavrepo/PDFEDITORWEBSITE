/**
 * Recent-sessions index for DevPilot.
 *
...
import {
  listRecentSessions,
  recordRecentSession,
} from "@/lib/devpilot/recent";

export const dynamic = "force-dynamic";

/** Lists the user's recent DevPilot sessions. */
...
export async function POST(request: NextRequest) {
  ...
  const limit = checkRateLimit(`dev-recents:${user.id}`, 120, 60_000);
