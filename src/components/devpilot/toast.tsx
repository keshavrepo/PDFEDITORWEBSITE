...
/**
 * Lightweight in-app toast for DevPilot.
 *
 * Mirrors the FinancePilot, OfficePilot and SocialPilot toast pattern
 * so every LaunchStack product shows the same surface. The host is
 * mounted once in the workspace shell; calls to `useToast().toast(...)`
 * queue a transient message that auto-dismisses after a short
 * timeout.
 */
