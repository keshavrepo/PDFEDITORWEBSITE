...
/**
 * Shared tool chrome for every DevPilot tool surface.
 *
 ...
 * full set of standard actions (copy, download, favourite, delete)
 * with a few lines of props.
 *
 * Mirrors the design language used by OfficePilot and SocialPilot
 * so every LaunchStack product looks the same to the user.
 */
