...
/**
 * Lightweight in-app toast for SocialPilot.
 *
 * Mirrors the FinancePilot and OfficePilot toast pattern so every
 * LaunchStack product shows the same surface. The host is mounted
 * once in the workspace shell; calls to `useToast().toast(...)` queue
 * a transient message that auto-dismisses after a short timeout.
 */
