...
export const products: Product[] = [
  ...
  },
  {
    ...
    accent: "text-primary",
    highlights: [
      "Integrated Terminal — multiple terminals, history, clear, copy, resize, fullscreen, keyboard shortcuts (Ctrl/Cmd + T, K, Shift + F)",
      ...
      "Project Validation — HTML / CSS / JavaScript validators, broken link detection, missing asset detection, duplicate ID detection, accessibility warnings, performance hints",
      "Project Export — export the complete project as a deterministic ZIP, with folders, assets and project.json manifest preserved",
      "Project Import — restore a ZIP back into the workspace with per-file conflict resolution and validation before import",
      "Workspace Productivity — Command Palette, keyboard shortcut reference, recent projects, quick actions, autosave controls, workspace settings",
