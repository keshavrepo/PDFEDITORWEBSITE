 ...
 * stream it. The platform keeps a small "recent sessions" mirror in
 ...
 *
 * Mirrors the SocialPilot / FinancePilot storage shape so a reader
 * who knows one product knows them all.
 */
...
export const STORAGE_DATABASE = "launchstack-devpilot";
