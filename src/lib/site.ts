...
export const internalRoutes = [
  ...
  "/products/imagepilot",
  "/imagepilot",
  "/imagepilot/screenshot-editor",
  "/imagepilot/watermark-studio",
  "/imagepilot/passport-photo",
  "/imagepilot/compressor",
  "/imagepilot/background-remover",
  "/imagepilot/object-blur",
  "/imagepilot/metadata-cleaner",
  "/imagepilot/converter",
  "/features",
  "/pricing",
  "/tools",
  "/api-docs",
